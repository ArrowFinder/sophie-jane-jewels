...
export const mockProducts: MockProduct[] = [
  ...
  build({
    ...
    sophiesNote:
      "This is the piece I still think about. Not because it was the most valuable, but because it was exactly right. If you are looking for a vintage gold and sapphire ring from the 1850s, start here, then tell me what you loved.",
    details: {
      era: "Victorian",
      circa: "c. 1850",
